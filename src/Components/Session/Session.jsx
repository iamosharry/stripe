    ...
    <div className='session'>
      <div className="session-container">
        <div className="left-session">
          ...
          <a href="#">Start now <span><img src="/assets/arrow-right-light.svg" alt="" /></span></a>
        </div>
        <div className="right-session">
          <div>
            <img src="/assets/swipe-sessions.png" alt="" />
            <img className='session-avatar1' src="/assets/avatar1.png" alt="" />
            <img className='session-avatar2' src="/assets/avatar2.png" alt="" />
            <div className='tbb'>
              <h3>Keynote</h3>
