    ...
    <div className='apiss'>
      <div className="apiss-container">
        <div className="left">
          ...
          <button className='first-btn'>Start now <span><img src="src/assets/arrow-right-dark.svg" alt="" /></span></button>

          <div className='inner-flex'>
            <div className="l2">
              <img src="src/assets/tools-icon.png" alt="" />
            ...
            <div className="r2">
              <img src="src/assets/cube-icon.png" alt="" />
        ...
        <div className="right">
          <div>
            <img src="src/assets/api-code.png" alt="" />
          </div>
          <div>
            <img src="src/assets/terminal-code.png" alt="" />
          </div>
        </div>
      </div>
    </div>
