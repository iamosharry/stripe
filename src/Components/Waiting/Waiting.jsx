    ...
    <div className='waiting'>
      <div className="waiting-container">
        <div className="left">
          ...
          <a className='left-btn'>Start now <img src="src/assets/arrow-right-light.svg" alt="" /></a>
        </div>
        <div className="right">
          <div>
            ...
            <a className='right-btn'>Pricing details <img src="src/assets/arrow-right-purple.svg" alt="" /></a>
          </div>
          <div>
            ...
            <a className='right-btn'>API reference <img src="src/assets/arrow-right-purple.svg" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
